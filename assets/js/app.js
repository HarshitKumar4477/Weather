        ...
        card.innerHTML = `
             <h2 class="title-2 card-title">Now</h2>
                        <div class="weaper">
                            ...
                            <img src="./assets/weather/${icon}.png" alt="${description}" class="weather-icon">
                        </div>
                        <p class="body-3">${description}</p>

                        <ul class="meta-list" data-meta-list>
                            <li class="meta-item">
                                <span class="material-symbols-outlined m-icon">
                                    calendar_today
                                </span>
            ...
            fetchData(url.reverseGeo(lat,lon),function([{name,country}]){
                const Li = document.createElement("li");
                    ...
                    `;
                    document.querySelector("[data-meta-list]").appendChild(Li);
            });
                 ...
                 <h2 class="title-2" id="highlights-label">
                        ...
                        <div class="highlights-list">
                            <div class="card card-sm highlight-card one">
                                ...
                                <div class="wrapper">
                                    <span class="material-symbols-outlined m-icon icon">air</span>
                                    <ul class="card-list">
                                        <li class="card-item">
                            ...
                            <div class="card card-sm highlight-card two">
                                ...
                                <div class="card-list">
                                    <div class="card-item">
                                        <span class="material-symbols-outlined m-icon">clear_day</span>
                                        <div>
                                            <p class="label-1">
                                                Sunrise
                                            </p>
                                    ...
                                    <div class="card-item">
                                        <span class="material-symbols-outlined m-icon">clear_night</span>
                                        <div>
                                            <p class="label-1">
                                                Sunset
                                            </p>
                            ...
                            <div class="card card-sm highlight-card">
                                ...
                                <div class="wrapper">
                                    <span class="m-icon material-symbols-outlined">humidity_percentage</span>
                            ...
                            <div class="card card-sm highlight-card">
                                ...
                                <div class="wrapper">
                                    <span class="m-icon material-symbols-outlined">
                                        airwave
                                    </span>
                                    <p class="title-1">
                            ...
                            <div class="card card-sm highlight-card">
                                ...
                                <div class="wrapper">
                                    <span class="m-icon material-symbols-outlined">visibility</span>
                            ...
                            <div class="card card-sm highlight-card">
                                ...
                                <div class="wrapper">
                                    <span class="m-icon material-symbols-outlined">thermostat</span>
                ...
                for (const [index , data] of forecastList.entries()) {
                    ...
                    tempLi.innerHTML = `
                        ...
                        <div class="card card-sm slider-card" >
                            ...
                            <img src="./assets/weather/${icon}.png" alt="${description}" class="weather-icon" width="55" height="55" loading="lazy" title="${description}">
                            <p class="body-3">
                                ${parseInt(temp)}&deg;
                            </p>
                        </div>
                    ...
                    windLi.innerHTML = `
                        ...
                        <div class="card card-sm slider-card">
                           ...
                           ${module.getHours(dateTimeUnix,timezone)}
                            ...
                            <img src="./assets/weather/direction.png" alt="Hour Cast" class="weather-icon" width="48" height="48" loading="lazy" title=""  style="transform: rotate(${windDirection-180}deg)">
                            <p class="body-3">
                 ...
                 */
                 ...
                 for(let i=7, len=forecastList.length;i<len ; i+=8){
                     ...
                     <div class="icon-wrapper">
                                 <img src="./assets/weather/${icon}.png" alt="${description}" width="36" height="36"
